                            ...
                            <nav>
                                <div class="ltn__main-menu">
                                    <ul>
                                        ...
                                        <li class=""><a href="{{url('shop')}}">Products</a>
                                ...
                                <div class="slide-item-info">
                                    <div class="slide-item-info-inner  ltn__slide-animation">
                                        ...
                                        <div class="btn-wrapper animated">
                                            <a href="{{url('shop')}}" class="theme-btn-1 btn btn-effect-1 text-uppercase">Belanja Sekarang</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-3 col-md-6 col-12">
                                <div class="ltn__feature-item ltn__feature-item-8">
                                    <div class="ltn__feature-icon">
                                        <img src="{{url('public/assets')}}/img/icons/svg/4-track.svg" alt="#">
                                    </div>
                                    <div class="ltn__feature-info">
                                        <h4>Gratis Ongkir</h4>
                                        <p>Minimal pembelian satu produk di berbagai wilayah</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6 col-12">
                                <div class="ltn__feature-item ltn__feature-item-8">
                                    <div class="ltn__feature-icon">
                                        <img src="{{url('public/assets')}}/img/icons/svg/5-madel.svg" alt="#">
                                    </div>
                                    <div class="ltn__feature-info">
                                        <h4>Kualitas Original</h4>
                                        <p>Produk 100% ori berasal dari pabrik langsung</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6 col-12">
                                <div class="ltn__feature-item ltn__feature-item-8">
                                    <div class="ltn__feature-icon">
                                        <img src="{{url('public/assets')}}/img/icons/svg/6-return.svg" alt="#">
                                    </div>
                                    <div class="ltn__feature-info">
                                        <h4>Pengembalian 3 Hari</h4>
                                        <p>Produk bisa dikembalikan jika pesanan salah yang dikirimkan</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6 col-12">
                                <div class="ltn__feature-item ltn__feature-item-8">
                                    <div class="ltn__feature-icon">
                                        <img src="{{url('public/assets')}}/img/icons/svg/7-support.svg" alt="#">
                                    </div>
                                    <div class="ltn__feature-info">
                                        <h4>Online Shop</h4>
                                        <p>Belanja cukup di rumah aja dengan smartphone</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6 col-sm-6 col-12">
                        <div class="footer-widget footer-about-widget">
                            <div class="footer-logo">
                                <div class="site-logo">
                                    <img src="{{url('public/assets')}}/img/logo3.png" alt="Logo">
                                </div>
                            </div>
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <div class="footer-address-info">
                                            <p>Jl. Rahadi Usman Desa Pesaguan Kiri Matan Hilir Selatan</p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="footer-address-icon">
                                        ...
                                        <div class="footer-address-info">
                                            <p><a href="tel:+0123-456789">0895-1258-1105</a></p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="footer-address-icon">
                                        ...
                                        <div class="footer-address-info">
                                            <p><a href="ifanrifaldi14@gmail.com">ifanrifaldi14@gmail.com</a></p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="col-xl-3 col-md-6 col-sm-12 col-12">
                        <div class="footer-widget footer-newsletter-widget">
                            ...
                            <p>Subscribe Dan Kunjungi Channel Kami
                                Untuk info terbaru mengenai product yang kami jual</p>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-12">
                                        <div class="modal-product-img">
                                            <img src="{{url('public/assets')}}/img/product/g1.jpg" alt="#">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-12">
